...
<template>
  <div class="container-bmw py-xl md:py-xxl">
    ...
    <h1 class="text-display-sm font-bold uppercase leading-none text-white md:text-display-md">Your Cart</h1>
    ...
    <div v-else class="mt-xl grid grid-cols-1 gap-xl lg:grid-cols-[1fr_380px]">
      ...
      <div>
        ...
        <NuxtLink to="/shop" class="mt-lg inline-flex items-center gap-2 text-label-uppercase uppercase tracking-[1.5px] text-white hover:text-m-red">
      ...
      <aside class="lg:sticky lg:top-24 lg:self-start">
        <div class="border border-hairline bg-surface-card">
          ...
          <div class="flex flex-col gap-md p-lg">
            ...
            <p v-if="remaining > 0" class="border border-hairline bg-surface-soft px-md py-2 text-caption text-body">Add <span class="text-white">{{ formatPrice(remaining) }}</span> more for FREE shipping.</p>
