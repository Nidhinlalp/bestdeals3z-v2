...
export const REVIEWS: Review[] = [
  ...
  { id: 'r4', name: 'Sneha Pillai', location: 'Thiruvananthapuram, KL', rating: 5, title: 'Best price I found', body: 'I compared the same drone on three sites. Cloud Scart was the cheapest and delivery was free. Will buy again.', date: '2026-03-30' },
